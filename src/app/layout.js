  ...
  return (
    <html lang='en'>
      <head>
        ...
        <link
          href='https://fonts.googleapis.com/css2?family=Actor&family=Amaranth:ital,wght@0,400;0,700;1,400;1,700&family=JetBrains+Mono:ital@0;1&family=Neonderthaw&display=swap'
          rel='stylesheet'
        />
      </head>
